...
def get_user_by_username_or_email(db_session: Session, username: str, email: str) -> User | None:
...
def user_exists(db_session: Session, username: str, email: str) -> bool:
    existing_user = get_user_by_username_or_email(db_session, username, email)
