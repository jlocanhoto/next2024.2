...
def validate_jwt(token: str) -> dict[str, Any] | None:
    try:
        ...
        print(err)
    # essa exceção de baixo (InvalidTokenError) é uma exceção que engloba todos os tipos de erros
    # acima e alguns outros e pode ser utilizada individualmente para simplificar a validação do JWT
